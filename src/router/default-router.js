...
//inventory
import Manufacturer from '../views/dashboard/inventory/manufacturer'
import Category from '../views/dashboard/inventory/category'
import Stock from '../views/dashboard/inventory/stock'
//customer
import Customer from '../views/dashboard/customer/customer'
import ViewCustomer from '../views/dashboard/customer/viewCustomer';
//Suppliers
import Suppliers from '../views/dashboard/suppliers/suppliers';
import ViewSuppliers from '../views/dashboard/suppliers/viewSuppliers';
//pos
import Pos from '../views/dashboard/pos/pos';
