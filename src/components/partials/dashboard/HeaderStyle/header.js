...
const Header = memo((props) => {
   ...
   const handleColorChange = ()=>{
        document.getElementById('color-mode-dark').click()
   }
    return (
        <Fragment>
            <Navbar expand="lg" variant="light" className={`nav iq-navbar ${headerNavbar} ${navbarHide.join(" ")}`}>
                <Container fluid className="navbar-inner">
                    <Link to="/dashboard" className="navbar-brand">
                        <Logo color={true} />
                        <h4 className="logo-title">Cell Home</h4>
                    </Link>
                    ...
                    <Navbar.Collapse  id="navbarSupportedContent">
                        ...
                        <Link className='text-white' to='/pos'><Button className='border rounded-pill' >POS</Button> </Link>
                        {/* <Button className='border rounded-pill' onClick={handleColorChange} >Dark</Button> */}
