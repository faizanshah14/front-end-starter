...
const ViewSuppliers = ({ defaultColumns }) => {
    ...
    <Fragment>
              ...
              <Row>
                <Card className="border-dark">
                  <Card.Header className="border-dark bg-primary d-flex justify-content-center">
                    <h3 className="mx-auto mb-4">Account Summary</h3>
                  </Card.Header>
                  <Card.Body>
                    <Row>
                      <Col md="4">
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>Add ViewSuppliers</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form>
            <Row className="mb-3">
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>Add Serialized ViewSuppliers</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form>
            <Row className="mb-3">
