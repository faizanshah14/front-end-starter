...
const Category = ({defaultColumns}) => {
    ...
    useEffect(() => {
        setData(splitCamelCaseKeys([
            {
                "id": 1,
                "category": "John Doe",
                "subCategory": "john.doe@example.com",
                "age": 30
            },
            {
                "id": 2,
                "category": "Jane Smith",
                "subCategory": "jane.smith@example.com",
                "age": 25
            },
            {
                "id": 3,
                "category": "Bob Johnson",
                "subCategory": "bob.johnson@example.com",
                "age": 35
            },
            {
                "id": 4,
                "category": "Alice Williams",
                "subCategory": "alice.williams@example.com",
                "age": 28
            }, {
                "id": 11,
                "category": "John Doe",
                    ...
                    <Form
                        ...
                        <Row className="mb-3">
                            <Col md="12">
                                ...
                                <Form.Control type="text" defaultValue=""  onChange={handleCategoryChange} value={category}  required/>
                                </FloatingLabel>
                            </Col>
                        </Row>
                        <Row className="mb-3">
                            <Col md="12">
                                <FloatingLabel controlId="floatingInput" label='Sub Category'  className="mb-3" >
                                <Form.Control as="textarea" defaultValue="" rows={3} onChange={handleSubCategoryChange} value={subCategory} required/>
                                </FloatingLabel>
                            </Col>
                        </Row>
                    </Form>
...
Category.defaultProps = {
    defaultColumns: {
        id: 1,
        category: "John Doe",
        'sub Category': "john.doe@example.com"
    }
};
